...
import { changePasswordSpecial, onlyForStopLoadingUI, resetPassword } from '../../redux/actions/userActions';
...
export default function ChangePasswordUser() {
    ...
    const tokenData = localStorage.getItem('FBIdToken');
    ...
    useEffect(() => {
        ...
        dispatch(setMainURL('Change Password'));
        dispatch(onlyForStopLoadingUI());
    ...
    const handleChangePassword = (e) => {
        ...
        if (changePassword !== confirmPassword) {
            ...
            dispatch(changePasswordSpecial(userData, router));
    ...
    return (
        <div className={classes.resetContainer}>
            <article>
                <Head>
                    <title>Tokyo Foam || Change Password User</title>
                </Head>
                {/* <p>Reset Password</p> */}
            </article>
            <div className={classes.container}>
                <div className={classes.boxInsideContainer}>
                    <div className={classes.boxText}>
                        <h1 className={classes.textReset}>Change Password</h1>
                    </div>

                    <div className={classes.resetBox}>
                        {/* <div className={classes.resetPassword}> */}
                        <div className={classes.boxReset}>
                            <p className={classes.textResetConfirm}>*New Password </p>
                            <TextField
                        ...
                        <div className={classes.boxConfirm}>
                            <p className={classes.textResetConfirm}>*Confirm New Password</p>
                            <TextField
