//label Profile ButtonTab types
export const SET_PROFILE_DASHBOARD = 'Dashboard';
...
export const SET_HEADER_EDIT_ADDRESS = 'Edit Address';
...
export const LOCATION_PATH_ADDRESS = '/profile/pages/profile-address';
export const LOCATION_PATH_ADDRESS_EDIT = '/profile/pages/profile-address-edit';
export const LOCATION_PATH_ADDRESS_ADD_NEW_ADDRESS = '/profile/pages/profile-address-new-address';
export const LOCATION_PATH_PROMO_AND_SALE = '/profile/pages/profile-promo-and-sale';
